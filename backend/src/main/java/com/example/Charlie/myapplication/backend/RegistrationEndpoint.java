 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.Charlie.example.com", ownerName = "backend.myapplication.Charlie.example.com", packagePath = ""))
